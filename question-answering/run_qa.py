...
class DataTrainingArguments:
    ...
    output_file: Optional[str] = field(
        default=None, 
        metadata={"help": "The output data file (a csv file)."}
    )
...
def main():
    ...
    def prepare_train_features(examples):
        ...
        tokenized_examples = tokenizer(
            ...
            [context_file[i] for i in examples[relevant_column_name]],
        ...
        for i in range(len(examples["id"])):
            examples["answer"][i]["answer_start"] = [examples["answer"][i]["start"]]
            examples["answer"][i]["text"] = [examples["answer"][i]["text"]]
        ...
        for i, offsets in enumerate(offset_mapping):
            ...
            answers = examples["answer"][sample_index] ## answer_column_name
    ...
    def prepare_validation_features2(examples):
        if "answer" in examples.keys() :
            examples["answers"] = {
                "answer_start": [examples["answer"]["start"]],
                "text": [examples["answer"]["text"]]    
            }
        return {"context": context_file[examples["relevant"]]}
